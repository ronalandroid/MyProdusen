...
export const navigationPolicy: readonly NavigationPolicyItem[] = [
  ...
  { key: 'attendance', name: 'Kehadiran', path: '/dashboard/attendance', primaryFor: ['EMPLOYEE'], allowedRoles: ['SUPERADMIN', 'EMPLOYEE'] },
  ...
  { key: 'leave', name: 'Cuti', path: '/dashboard/leave', primaryFor: ['SUPERADMIN', 'EMPLOYEE'], allowedRoles: ['SUPERADMIN', 'EMPLOYEE'] },
  { key: 'kpi', name: 'KPI', path: '/dashboard/kpi', primaryFor: ['SUPERADMIN', 'EMPLOYEE'], allowedRoles: ['SUPERADMIN', 'EMPLOYEE'] },
  { key: 'reports', name: 'Laporan', path: '/dashboard/reports', primaryFor: ['SUPERADMIN'], allowedRoles: ['SUPERADMIN'] },
  { key: 'payroll', name: 'Gaji', path: '/dashboard/payroll', primaryFor: [], allowedRoles: ['SUPERADMIN', 'EMPLOYEE'] },
  { key: 'overtime', name: 'Lembur', path: '/dashboard/overtime', primaryFor: ['EMPLOYEE'], allowedRoles: ['SUPERADMIN', 'EMPLOYEE'] },
