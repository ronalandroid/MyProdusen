...
export const PERMISSIONS: Record<string, readonly UserRole[]> = {
  ...
  // Payroll
  PAYROLL_READ: ['SUPERADMIN', 'ADMIN_HR'],
  PAYROLL_READ_OWN: ['EMPLOYEE'],
  PAYROLL_MUTATE: ['SUPERADMIN', 'ADMIN_HR'],
  PAYROLL_APPROVE: ['SUPERADMIN'],
  PAYROLL_PAY: ['SUPERADMIN'],
  PAYROLL_EXPORT: ['SUPERADMIN', 'ADMIN_HR'],
