...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with the admin credentials and click the 'Masuk' (submit) button to sign in.
        ...
        # -> Click the 'Cuti' (leave) sidebar link to open the leave balance screen, then wait for the page to settle.
        # link "Cuti"
