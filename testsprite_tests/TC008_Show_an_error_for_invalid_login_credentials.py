...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Masuk Sistem' link to navigate to the login page (element index 8).
        # link "Masuk Sistem"
        elem = page.locator("xpath=/html/body/div[2]/div/nav/div[2]/a").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Fill the email field (index 283) with an invalid email and then fill the password (index 295) and submit (index 303).
        ...
        await elem.wait_for(state="visible", timeout=10000)
        await elem.fill("fakeuser@example.com")
