...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields with an inactive account's credentials and submit the login form, then inspect the page for an 'inactive account' error message.
        ...
        await elem.fill("inactive@myprodusen.com")
