...
| Attendance | Check-in/out/list/today exist; mobile page captures GPS + selfie data URL | Durable selfie storage, manual adjustment route, unique day constraint | P0 |
