...
|---|---|---|---|
| Auth | Login/register/profile/change-password exist | Dashboard guard, token refresh against DB, rate limit | P0 |
...
| Attendance | Check-in/out/list exist | Today endpoint, selfie storage, manual adjustment route, unique day constraint | P0 |
...
- `/api/attendance/today` is planned, not implemented.
