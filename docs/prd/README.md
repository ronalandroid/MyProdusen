...
Sistem produksi menggunakan dua role akun utama dengan pengalaman UI/UX berbeda:
...
- Seed/demo production-like hanya membuat akun Superadmin dan Employee; jangan membuat akun Admin HR atau Supervisor baru.
