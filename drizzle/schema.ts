...
export const employeePayrolls = pgTable('EmployeePayroll', {
  ...
  trainingStatus: text('trainingStatus').default('FULL_TIME').notNull(),
  trainingEndDate: timestamp('trainingEndDate', { mode: 'date' }),
  customAmount: decimal('customAmount', { precision: 15, scale: 2, mode: 'number' }),
...
export const payrollRuns = pgTable('PayrollRun', {
  ...
  totalGrossPay: decimal('totalGrossPay', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  totalDeductions: decimal('totalDeductions', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  totalNetPay: decimal('totalNetPay', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const payrollItems = pgTable('PayrollItem', {
  ...
  employeeId: text('employeeId').notNull(),
  baseSalary: decimal('baseSalary', { precision: 15, scale: 2, mode: 'number' }).notNull(),
  totalAllowances: decimal('totalAllowances', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  totalDeductions: decimal('totalDeductions', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  overtimePay: decimal('overtimePay', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  attendanceDeduction: decimal('attendanceDeduction', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  taxAmount: decimal('taxAmount', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  bpjsKesehatanEmployee: decimal('bpjsKesehatanEmployee', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  bpjsKesehatanCompany: decimal('bpjsKesehatanCompany', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  bpjsKetenagakerjaanEmployee: decimal('bpjsKetenagakerjaanEmployee', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
  bpjsKetenagakerjaanCompany: decimal('bpjsKetenagakerjaanCompany', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const overtimeRequests = pgTable('OvertimeRequest', {
  ...
  calculatedPay: decimal('calculatedPay', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const expenseCategories = pgTable('ExpenseCategory', {
  ...
  name: text('name').notNull(),
  description: text('description'),
  maxAmount: decimal('maxAmount', { precision: 15, scale: 2, mode: 'number' }), // Maximum allowed per claim
...
export const expenseClaims = pgTable('ExpenseClaim', {
  ...
  totalAmount: decimal('totalAmount', { precision: 15, scale: 2, mode: 'number' }).notNull(),
...
export const payrollRules = pgTable('PayrollRule', {
  ...
  baseSalary: decimal('baseSalary', { precision: 15, scale: 2, mode: 'number' }).notNull(),
  baseAmount: decimal('baseAmount', { precision: 15, scale: 2, mode: 'number' }),
  trainingAmount: decimal('trainingAmount', { precision: 15, scale: 2, mode: 'number' }),
  fullAmount: decimal('fullAmount', { precision: 15, scale: 2, mode: 'number' }),
...
export const attendancePolicies = pgTable('AttendancePolicy', {
  ...
  lateTier1Deduction: decimal('lateTier1Deduction', { precision: 15, scale: 2, mode: 'number' }).default(5000).notNull(),
  lateTier2Min: integer('lateTier2Min').default(16).notNull(),
  lateTier2Max: integer('lateTier2Max').default(30).notNull(),
  lateTier2Deduction: decimal('lateTier2Deduction', { precision: 15, scale: 2, mode: 'number' }).default(10000).notNull(),
...
export const attendanceDailySummaries = pgTable('AttendanceDailySummary', {
  ...
  lateMinutes: integer('lateMinutes').default(0).notNull(),
  lateDeduction: decimal('lateDeduction', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
...
export const payrollCalculationHistory = pgTable('PayrollCalculationHistory', {
  ...
  description: text('description').notNull(),
  amount: decimal('amount', { precision: 15, scale: 2, mode: 'number' }).default(0).notNull(),
